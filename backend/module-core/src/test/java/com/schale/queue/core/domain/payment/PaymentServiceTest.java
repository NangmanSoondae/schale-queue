...
class PaymentServiceTest {
    ...
    @Test
    @DisplayName("확정: READY 결제를 PAID 로, 재고 reserved→sold(confirm), 주문 COMPLETED")
    void confirm_marks_paid_and_confirms_stock() {
    ...
    @Test
    @DisplayName("확정 멱등: 이미 PAID 면 PaymentNotConfirmableException, 재고 미변경")
